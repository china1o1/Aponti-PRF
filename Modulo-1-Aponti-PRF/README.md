...
Análise de acidentes de trânsito em rodovias federais (dados abertos da PRF, 2025), com foco em entender **o que mais influencia a ocorrência de vítimas fatais**. O mesmo problema é atacado 5 vezes, cada uma com uma ferramenta diferente (Excel, SQL e Python), para construir a mesma análise em profundidade crescente — da exploração inicial até uma base pronta para modelagem preditiva.
...
| [Unidade 5](./Unidade%205) | Excel | Consolidação final: KPIs do projeto, ranking de rodovias mais letais e tabelas dinâmicas com interpretação escrita ao lado de cada uma. | [ver](./Unidade%205/README.md) |
...
## Conclusão consolidada do projeto

Passando pelas 5 unidades, um padrão se repete de forma consistente, independente da ferramenta usada: **volume de acidentes e gravidade não andam juntos.**
...
Essa é a principal contribuição do projeto: usar 3 tecnologias diferentes não para triplicar o trabalho, mas para **validar cruzado** a mesma conclusão — o que dá bem mais confiança ao resultado do que se ele tivesse aparecido em uma análise única.
